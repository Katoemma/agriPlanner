            ...
            <div class="bg-white p-2 md:p-10 flex flex-col w-full shadow-xl rounded-xl">
                ...
                <form action="login.php" method="post" class="w-full ">
                    ...
                    <div id="button" class="flex flex-col w-full my-5">
                        <button type="submit" name="loginBtn" class="w-full py-4 bg-green-600 rounded-lg text-green-100">
                        ...
                        <a href="forgotPass.php" class="w-full text-center font-medium text-red-500">Forgot password</a>
                        <a href="register.php" class="w-full text-center font-medium text-blue-500">No Account? Sign up</a>
                        </div>
                    </div>
                </form>
            </div>
